...
public class CameraViewInWorld : MonoBehaviour 
{
    ...
    {
        //左下
        //Vector2 screen_L_D = Vector2.zero;
        ////右上
        //Vector2 screen_R_U = Vector2.zero;
        //screen_R_U.x = Camera.main.GetComponent<Camera>().pixelWidth;
        //screen_R_U.y = Camera.main.GetComponent<Camera>().pixelHeight;
        ////左上
        //Vector2 screen_L_U = Vector2.zero;
        //screen_L_U.y = screen_R_U.y;
        ////右下
        //Vector2 screen_R_D = Vector2.zero;
        //screen_R_D.x = screen_R_U.x;

        //Debug.Log("screen_L_D " + screen_L_D
        //    + "screen_R_U " + screen_R_U
        //    + "screen_L_U " + screen_L_U
        //    + "screen_R_D " + screen_R_D);
